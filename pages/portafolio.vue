<template>
  <div class="contaier">
    ...
    <section class="section-1 center" id="section-1">
      ...
      <img :src="avatar" alt="John Smith" class="person-img" />
    ...
    <section class="section-2" id="section-2">
      ...
      <div class="services">
        <div class="service">
          <font-awesome-icon class="icon" :icon="['far', 'lightbulb']" />
          <h2 class="service-heading">Creative</h2>
        </div>
        <div class="service">
          <font-awesome-icon class="icon" :icon="['fas', 'scissors']" />
          <h2 class="service-heading">Problem Solving</h2>
        </div>
        <div class="service">
          <font-awesome-icon class="icon" :icon="['fas', 'gauge-high']" />
    ...
    <section class="section-3" id="section-3">
      ...
      <div class="projects-wrapper center">
        ...
        <div class="project">
          ...
          <img :src="project3" class="project-img" />
          <a
            href="#"
            class="project-link"
            @click.prevent
        ...
        <div class="project">
          ...
          <img :src="project4" class="project-img" />
          <a
            href="#"
            class="project-link"
            @click.prevent
        ...
        <div class="project">
          ...
          <img :src="project5" class="project-img" />
          <a
            href="#"
            class="project-link"
            @click.prevent
        ...
        <div class="project">
          ...
          <img :src="project6" class="project-img" />
          <a
            href="#"
            class="project-link"
            @click.prevent
        ...
        <div class="project">
          ...
          <img :src="project7" class="project-img" />
          <a
            href="#"
            class="project-link"
            @click.prevent
        ...
        <div class="project">
          ...
          <img :src="project8" class="project-img" />
          <a
            href="#"
            class="project-link"
            @click.prevent
        ...
        <div class="project">
          ...
          <img :src="project9" class="project-img" />
          <a
            href="#"
            class="project-link"
            @click.prevent
    ...
    <section class="section-4" id="section-4">
      ...
      <form class="contact-form center" @submit.prevent>
...
import avatar from "~/assets/img/portafolio/john-smith.jpg";
import project1 from "~/assets/img/portafolio/project-1.jpg";
import project2 from "~/assets/img/portafolio/project-2.jpg";
import project3 from "~/assets/img/portafolio/project-3.jpg";
import project4 from "~/assets/img/portafolio/project-4.jpg";
import project5 from "~/assets/img/portafolio/project-5.jpg";
import project6 from "~/assets/img/portafolio/project-6.jpg";
import project7 from "~/assets/img/portafolio/project-7.jpg";
import project8 from "~/assets/img/portafolio/project-8.jpg";
import project9 from "~/assets/img/portafolio/project-9.jpg";
...
.section-1 {
  ...
  background: linear-gradient(
    ...
    url("~/assets/img/portafolio/bg.jpg") center no-repeat;
