<template>
  <div class="container">
    ...
    <header class="header center">
      ...
      <img :src="imgBaloon" alt="Header Image" class="header-image" />
      <div class="logo">
        <h1>
      ...
      <div class="cards-wrapper">
        <div class="card">
          <div class="front-side">
            <img :src="imgForest" alt="Forest" class="card-image" />
        ...
        <div class="card">
          <div class="front-side">
            <img :src="imgRiver" alt="River" class="card-image" />
        ...
        <div class="card">
          <div class="front-side">
            <img :src="imgSea" alt="Sea" class="card-image" />
    ...
    <section class="stories">
      ...
      <div class="stories-wrapper">
        <div class="story-bg">
          <div class="story">
            <img :src="imgStoryOne" alt="Customer image" class="story-image" />
        ...
        <div class="story-bg">
          <div class="story">
            <img :src="imgStoryTwo" alt="Customer image" class="story-image" />
            <div class="story-text">
...
import imgBaloon from "~/assets/img/road/air-balloon.png";
import imgForest from "~/assets/img/road/forest.jpg";
import imgRiver from "~/assets/img/road/river.jpg";
import imgSea from "~/assets/img/road/sea.jpg";
import videoBg from "~/assets/img/road/video.mp4";
import imgStoryOne from "~/assets/img/road/story-img-1.jpg";
import imgStoryTwo from "~/assets/img/road/story-img-2.jpg";

const initializeDOMEffects = () => {
...
.navbar {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)),
    url("assets/img/road/navbar-bg.jpg") center no-repeat;
...
.header {
  ...
  background: linear-gradient(rgba(18, 113, 255, 0.5), rgba(18, 113, 255, 0.3)),
    url("assets/img/road/header-bg.jpg") center no-repeat;
  background-size: cover;
  position: relative;
  perspective: 100rem;
}
...
.contact {
  ...
  text-align: center;
  background: url("assets/img/road/contact-us-bg.png") center no-repeat;
  background-size: cover;
